...
namespace BuckarooSdk.Tests.Services.INGHomePay
{
	[TestClass]
	public class INGHomePayTests
	{
		private SdkClient _buckarooClient;
		private string TestName => nameof(INGHomePayTests).ToUpper();
		...
		public void PayTest()
		{
			var request =
				...
				.INGHomePay() // Choose the paymentmethod you want to use
				.Pay(new INGHomePayPayRequest // choose the action you want to use and provide the payment method specific info.
				{

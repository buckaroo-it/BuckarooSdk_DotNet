...
namespace BuckarooSdk.Tests.Services.KbcPaymentButton
{
	[TestClass]
	public class KbcPaymentButtonTests
	{
		private SdkClient _buckarooClient;
		private string TestName => nameof(KbcPaymentButtonTests).ToUpper();
		...
		public void PayTest()
		{
			var request =
				...
				.KbcPaymentButton() // Choose the paymentmethod you want to use
				.Pay(new KbcPaymentButtonPayRequest // choose the action you want to use and provide the payment method specific info.
				{
		...
		public void RefundTest()
		{
			var request =
				...
				.KbcPaymentButton() // Choose the paymentmethod you want to use
				.Refund(new KbcPaymentButtonRefundRequest // choose the action you want to use and provide the payment method specific info.
				{
		...
		public void PayRemainderTest()
		{
			var request =
				...
				.KbcPaymentButton() // Choose the paymentmethod you want to use
				.PayRemainder(new KbcPaymentButtonPayRemainderRequest // choose the action you want to use and provide the payment method specific info.
				{

...
namespace BuckarooSdk.Tests.Services.AfterpayDigiaccept
{
	[TestClass]
	public class AfterpayDigiacceptTests
	{
		private SdkClient _buckarooClient;
		private string TestName => nameof(AfterpayDigiacceptTests).ToUpper();
		...
		public void PayTest()
		{
			var request = 
				...
				.SetBasicFields(new TransactionBase // The transactionbase contains the base information of a transaction.
				{
					...
					AmountDebit = 2,Invoice = $"SDK_{ TestName }_{ DateTime.Now.Ticks }",Order = $"SDK_{ TestName }_{ DateTime.Now.Ticks }",
				})
				.AfterpayDigiaccept() // Choose the paymentmethod you want to use
				.Pay(new AfterpayDigiacceptPayRequest // choose the action you want to use and provide the payment method specific info.
				{
					ShippingCosts = 0, 
Discount = 0, 
		...
		public void RefundTest()
		{
			var request = 
				...
				.SetBasicFields(new TransactionBase // The transactionbase contains the base information of a transaction.
				{
					...
					ReturnUrlError = TestSettings.ReturnUrlError,
					ReturnUrlReject = TestSettings.ReturnUrlReject,
					Invoice = $"SDK_{ TestName }_{ DateTime.Now.Ticks }",OriginalTransactionKey = "",AmountCredit = 2,Order = $"SDK_{ TestName }_{ DateTime.Now.Ticks }",
				})
				.AfterpayDigiaccept() // Choose the paymentmethod you want to use
				.Refund(new AfterpayDigiacceptRefundRequest // choose the action you want to use and provide the payment method specific info.
				{
					ArticleDescription = string.Empty, 
ArticleId = string.Empty, 
ArticleQuantity = 0, 
...
ArticleNetUnitprice = 0, 
		...
		public void AuthorizeTest()
		{
			var request = 
				...
				.AfterpayDigiaccept() // Choose the paymentmethod you want to use
				.Authorize(new AfterpayDigiacceptAuthorizeRequest // choose the action you want to use and provide the payment method specific info.
				{
					ShippingCosts = 0, 
Discount = 0, 
Accept = false, // Mandatory
		...
		public void CaptureTest()
		{
			var request = 
				...
				.SetBasicFields(new TransactionBase // The transactionbase contains the base information of a transaction.
				{
					...
					ReturnUrlError = TestSettings.ReturnUrlError,
					ReturnUrlReject = TestSettings.ReturnUrlReject,
					AmountDebit = 2,Invoice = $"SDK_{ TestName }_{ DateTime.Now.Ticks }",OriginalTransactionKey = "",Order = $"SDK_{ TestName }_{ DateTime.Now.Ticks }",
				})
				.AfterpayDigiaccept() // Choose the paymentmethod you want to use
				.Capture(new AfterpayDigiacceptCaptureRequest // choose the action you want to use and provide the payment method specific info.
				{
					ArticleDescription = string.Empty, 
ArticleId = string.Empty, 
ArticleQuantity = 0, 
...
ArticleNetUnitprice = 0, 
		...
		public void CancelAuthorizeTest()
		{
			var request = 
				...
				.AfterpayDigiaccept() // Choose the paymentmethod you want to use
				.CancelAuthorize(new AfterpayDigiacceptCancelAuthorizeRequest // choose the action you want to use and provide the payment method specific info.
				{
